            ...
            `}>
                ...
                <div className="p-4 mt-auto border-t border-slate-800/50">
                    ...
                    >
                        ...
                        {(isSidebarOpen || isMobileMenuOpen) && <span className="ml-4 tracking-wide">Log Out</span>}
                    </button>
                </div>
            </aside>
                ...
                <header className="bg-white/70 backdrop-blur-xl border-b border-indigo-100/50 p-4 px-4 sm:px-8 flex justify-between items-center sticky top-0 z-20 shadow-sm">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <p className="text-[10px] font-black text-indigo-600 uppercase tracking-[0.2em] leading-none mb-1 hidden sm:block">Navigation /</p>
                            <h2 className="text-xl font-black text-slate-800 tracking-tight truncate max-w-[150px] sm:max-w-none">
